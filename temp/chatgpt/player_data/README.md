...
# ---------------------------------------
# Reconstruct a full match timeline
# ---------------------------------------

# Pick one match ID for testing
match_id = "b3550292-8f80-493a-a422-95c4e70f0a5e.nakama-0"

# Get all humans/bots/events belonging to this match
match_timeline = df_feb10[
    df_feb10["match_id"] == match_id
].copy()

# Sort all events chronologically
match_timeline = match_timeline.sort_values(
    by="ts"
